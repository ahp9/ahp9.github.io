document.addEventListener("DOMContentLoaded", function () {
  d3.csv("/assets/data/alcohol_sales.csv").then(function (data) {
    ...
    Plotly.newPlot('alcohol_sales_1998_2015', traces, layout);
  });
});